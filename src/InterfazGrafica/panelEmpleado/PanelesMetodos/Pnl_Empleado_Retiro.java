...
public class Pnl_Empleado_Retiro extends javax.swing.JPanel {
    
    private Banco banco;
    private Usuario usuarioActual;
    
    public Pnl_Empleado_Retiro(Banco banco, Usuario usuarioActual) {
        initComponents();
        this.banco = banco;
    ...
    private void initComponents() {
        ...
        boletaRetiro = new javax.swing.JPanel();
    ...
    private void btnRetirarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRetirarActionPerformed
        ...
        try {
            Retiro nuevoRetiro = banco.getgTransacciones().procesarRetiro(usuarioActual, numCuentaEntry, montoEntry, dniEntry, claveEntry);
    ...
    private javax.swing.JPanel boletaRetiro;
